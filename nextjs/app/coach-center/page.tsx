...
export default function CoachCenterPage() {
  ...
  const handleStartInterview = (resumeId: string, resumeName: string, roleTitle: string, level: string) => {
    setInterviewSession({ resumeId, resumeName, roleTitle, roleLevel: level });
